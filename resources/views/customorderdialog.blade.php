<div 
  x-show="showCustomDialog" 
  x-cloak 
  x-transition.opacity.duration.200ms
  @keydown.escape.window="showCustomDialog = false"
  class="fixed inset-0 z-50 flex items-center justify-center bg-black/50">

  {{-- Box isi modal --}}
  <div 
    @click.outside="showCustomDialog = false" 
    ...
    <div x-data="{ tab: 'customer' }">
      <div class="grid grid-cols-4 border-b mb-6">
        <button type="button" @click="tab = 'customer'" :class="tab === 'customer' ? 'border-b-2 border-blue-600 text-blue-600' : 'text-gray-600'"
          class="py-2 font-medium text-center">Customer</button>
        <button type="button" @click="tab = 'product'" :class="tab === 'product' ? 'border-b-2 border-blue-600 text-blue-600' : 'text-gray-600'"
          class="py-2 font-medium text-center">Product</button>
        <button type="button" @click="tab = 'measurements'" :class="tab === 'measurements' ? 'border-b-2 border-blue-600 text-blue-600' : 'text-gray-600'"
          class="py-2 font-medium text-center">Measurements</button>
        <button type="button" @click="tab = 'payment'" :class="tab === 'payment' ? 'border-b-2 border-blue-600 text-blue-600' : 'text-gray-600'"
    ...
    <div class="mt-6 flex justify-end gap-2 border-t pt-4">
      ...
      <button type="button" class="bg-blue-600 text-white rounded-lg px-4 py-2 hover:bg-blue-700">
        Save Order
      </button>
    </div>
